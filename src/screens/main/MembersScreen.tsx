...
const styles = StyleSheet.create({
  ...
  bannerHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 10 },
  bannerIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: Colors.brandSubdued, borderWidth: 1, borderColor: Colors.brandBorder, alignItems: 'center', justifyContent: 'center' },
  bannerLabel: { fontSize: 9.5, fontFamily: 'monospace', fontWeight: '700', color: Colors.textMuted, letterSpacing: 0.8, marginBottom: 3 },
  codeText: { fontSize: 22, fontFamily: 'monospace', fontWeight: '800', color: Colors.brand, letterSpacing: 3 },
  bannerDesc: { fontSize: 11.5, color: Colors.textMuted, lineHeight: 17, marginBottom: 14 },
  bannerActions: { flexDirection: 'row', gap: 10 },
  codeActionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: Colors.surfaceElevated, borderWidth: 1, borderColor: Colors.border, borderRadius: 10, paddingVertical: 10 },
  shareBtn: { backgroundColor: Colors.brand, borderColor: Colors.brand },
  codeActionText: { fontSize: 12.5, fontWeight: '600', color: Colors.text },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: Colors.text, letterSpacing: -0.2 },
  inviteBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: Colors.brand, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10 },
  inviteBtnText: { fontSize: 12, fontWeight: '700', color: Colors.white },
  soloMemberTip: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: Colors.brandSubdued, borderWidth: 1, borderColor: Colors.brandBorder, borderRadius: 14, padding: 14, marginTop: 10 },
  soloTipTitle: { fontSize: 13, fontWeight: '700', color: Colors.text, marginBottom: 4 },
  soloTipDesc: { fontSize: 11.5, color: Colors.textSecondary, lineHeight: 17 },
});
